...
public interface NYTAPI {
    ...
    Call<Results> getNYTbooks(@Path ("section") String section, @Query("apikey") String apikey);

    @GET("svc/topstories/v2/travel.json")
    Call<Results> getNYTtravel(@Path ("section") String section, @Query("apikey") String apikey);

    @GET("svc/topstories/v2/fashion.json")
    Call<Results> getNYTfashion(@Path ("section") String section, @Query("apikey") String apikey);
